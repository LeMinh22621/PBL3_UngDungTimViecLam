...
('PF2',(SELECT * FROM OPENROWSET(BULK N'C:\Users\ADMIN\Desktop\PBL\PBL3_UngDungTimViecLam\Image\lop.jpg', SINGLE_BLOB) as IMAGE),'LHM','HA TINH','0763034216','LHM2K1@GMAIL.COM',NULL,NULL),
('PF3',(SELECT * FROM OPENROWSET(BULK N'C:\Users\ADMIN\Desktop\PBL\PBL3_UngDungTimViecLam\Image\lop.jpg', SINGLE_BLOB) as IMAGE),'LHM','HA TINH','0763034216','LHM2K1@GMAIL.COM',NULL,NULL),
('PF4',(SELECT * FROM OPENROWSET(BULK N'C:\Users\ADMIN\Desktop\PBL\PBL3_UngDungTimViecLam\Image\lop.jpg', SINGLE_BLOB) as IMAGE),'LHM','HA TINH','0763034216','LHM2K1@GMAIL.COM',NULL,NULL)
