...
(
	...
	CONSTRAINT PK_TB_COMMUNICATION PRIMARY KEY (ID_EMPLOYER, ID_JOBSEEKER, ID_POST),
	...
	CONSTRAINT FK_TB_ID_POST FOREIGN KEY(ID_POST) REFERENCES TB_POST(ID_POST)
)
ALTER TABLE TB_DETAIL_CV_AND_POST ADD STATUS BIT
ALTER TABLE TB_DETAIL_CV_AND_POST ADD DATETIME DATETIME
ALTER TABLE TB_POST ADD DATETIME DATETIME
/*
alter table TB_COMMUNICATION add ID_POST nvarchar(10)
