...
public class Admin extends JFrame implements ActionListener, WindowListener {
	...
	private void initialize() {
		...
		String[] nameOfColumnsPost = { "ID_POST", "EMPLOYER_NAME", "CATEGORY_JOB_NAME", "JOB_NAME", "COMPANY_NAME",
				"CITY", "SALARY", "DESCIPTION_JOB", "LABOR", "STATUS" };
		...
		tableContentsG.addMouseListener(new MouseListener() {
			...
			@Override
			public void mouseClicked(MouseEvent e) {
				if (tableContentsG.getSelectedRowCount() > 0 && !Boolean
						.parseBoolean(tableContentsG.getValueAt(tableContentsG.getSelectedRow(), 9).toString())) {
